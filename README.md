...
```text
.
├── clusters.py      # Hierarchical clustering, PCA, and visualization of clustering results
├── fit.py           # Visualization of model performance comparison
├── SHAPfgas.py      # SHAP-based driver analysis for F-gases
└── README.md
File Description
1. clusters.py
